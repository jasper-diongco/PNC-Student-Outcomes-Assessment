<template>
    <div>
        ...
        <!-- Modal -->
        <div class="modal fade" :id="isUpdate ? 'mathModalUpdate' : 'mathModal'" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
          <div class="modal-dialog" role="document">
            <div class="modal-content">
              <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">Add Equation <i class="fa fa-superscript text-success"></i></h5>
              ...
              <div class="modal-body">
                <mathlive-mathfield 
                    ...
                    <div>
                        <button class="btn-math" v-on:click="sayIt">Say It</button>
                    </div>
              </div>
              <div class="modal-footer">
                <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
                <button type="button" class="btn btn-primary" @click="saveEquation">Save</button>
              </div>
            </div>
          </div>
        </div>
...
<script>
    export default {
        ...
        methods: {
            ...
            getEquation() {
                ApiClient.get('/math_objects/' + this.id)
                .then(response => {
