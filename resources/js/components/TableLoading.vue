      ...
      >
        ...
        >
          <circle
            ...
            fill-opacity="1"
            style="animation-play-state: running; animation-delay: 0s;"
            transform="scale(1.05712 1.05712)"
          >
            <animateTransform
      ...
      >
        ...
        >
          <circle
            ...
            fill-opacity="0.875"
            style="animation-play-state: running; animation-delay: 0s;"
            transform="scale(1.06962 1.06962)"
          >
            <animateTransform
              attributeName="transform"
              type="scale"
      ...
      >
        ...
        >
          <circle
            ...
            fill-opacity="0.75"
            style="animation-play-state: running; animation-delay: 0s;"
            transform="scale(1.08212 1.08212)"
          >
            <animateTransform
              attributeName="transform"
              type="scale"
      ...
      >
        ...
        >
          <circle
            ...
            fill-opacity="0.625"
            style="animation-play-state: running; animation-delay: 0s;"
            transform="scale(1.09462 1.09462)"
          >
            <animateTransform
              attributeName="transform"
              type="scale"
      ...
      >
        ...
        >
          <circle
            ...
            fill-opacity="0.375"
            style="animation-play-state: running; animation-delay: 0s;"
            transform="scale(1.01962 1.01962)"
          >
            <animateTransform
              attributeName="transform"
              type="scale"
      ...
      >
        ...
        >
          <circle
            ...
            fill-opacity="0.25"
            style="animation-play-state: running; animation-delay: 0s;"
            transform="scale(1.03212 1.03212)"
          >
            <animateTransform
              attributeName="transform"
              type="scale"
      ...
      >
        ...
        >
          <circle
            ...
            fill-opacity="0.125"
            style="animation-play-state: running; animation-delay: 0s;"
            transform="scale(1.04462 1.04462)"
          >
            <animateTransform
              attributeName="transform"
              type="scale"
