        ...
        var vm = new Vue({
            ...
            methods: {
                ...
                changeAccountInformation() {
                    this.formAccountInfo.post(myRootURL + '/s/my_profile/'+ this.user.id +'/update_account_information')
                    .then(response => {
                ...
                changePassword() {
                    this.formChangePassword.post(myRootURL + '/s/my_profile/'+ this.user.id +'/update_password')
                    .then(response => {
                        toast.fire({
                ...
                changeBasicInformation() {
                    this.formBasicInfo.post(myRootURL + '/s/my_profile/'+ this.user.id +'/update_basic_info')
                    .then(response => {
                        toast.fire({
